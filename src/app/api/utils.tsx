export function formatDateWithIntl(dateString: string) {
  ...
  export function generateDecades(startDecade = new Date().getFullYear(), endDecade = 1950) {
    const decades = [];
  ...
  export function generateYears(selectedDecade: number, upcomming?: string) {
    ...
    if (upcomming) {
      ...
      const endYear = currentDecadeStart === selectedDecade ? currentYear : selectedDecade + 9;
